...
import logo from "../images/bridgelogo.png";
    ...
    return(
       <>
        <header className='navbar' style={{boxShadow: "3px 3px 10px #15ba06"}}>
            ...
            <div className='navbar__item'>
            <a style={{color: 'black',textDecoration: 'none'}} href="http://localhost:3000/smartpractice">Discuss</a>
            </div>
            {/* <div className='navbar__item'>About Us</div> */}
            <div className='navbar__item'>
            <a style={{color: 'black',textDecoration: 'none'}} href="http://localhost:3000/discuss">Search Job</a>
            </div>
            <div className='navbar__item'>
