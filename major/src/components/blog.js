...
return (
    <div>
      <Navbar></Navbar>
        <div >
        <a className="btn" href="http://localhost:3000/post" style={{"margin-left" : "30px"}}><input className="btn" type="button" style={mystyle2} value="Post a Blog"/></a>
        </div>
        <br></br>
        <br></br>
        {repo.map((repos)=> (
      ...
      <MDBCardBody>
        <MDBCardTitle>Blog No. {repos.id}</MDBCardTitle>
        <hr></hr>
        <MDBCardText>
          {repos.doubt}
        </MDBCardText>
